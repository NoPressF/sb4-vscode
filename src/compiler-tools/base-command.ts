...
export abstract class BaseCommand extends Singleton implements vscode.Disposable {
    ...
    private readonly executeOptions: Record<ExecuteType, ExecuteInfo> = {
        ...
        [ExecuteType.DECOMPILE]: { commandName: 'decompileScript', flag: 'decompile', logFileName: 'decompile.log', operationTitle: 'Decompiling', successMessage: 'Decompile succeeded', errorMessagePrefix: 'Decompile failed' },
    };
    ...
    private async executeOperation(filePath: string) {
        ...
        const logPath = path.join(sb4FolderPath, executeOptions.logFileName);
